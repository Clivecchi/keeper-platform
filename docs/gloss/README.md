...
### 2026-09-13 — Training is not Agency
- Added `2026-09-13-training-vs-agency.md` — Training frames are markdown slices of `config.voice_prompt`, not Agency contracts. Gloss-only.
