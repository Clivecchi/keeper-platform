...
## 📆 Update Log
- 2026-09-21: **Document Orientation** — `Dialog.orientation`, `orientation_updated_at`, `orientation_updated_by`. Migration `20260921203000_dialog_document_orientation`. Beside Forward. Nullable.
