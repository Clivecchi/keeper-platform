...
## 📆 Update Log
- **2026-09-16**: `GrantPermissionRequest.role` / `UpdatePermissionParams.role` are strings so a Domain can store custom People role keys that still use the four permission bundles.
