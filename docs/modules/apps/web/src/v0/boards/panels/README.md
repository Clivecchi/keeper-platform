...
- `UniversalViewPanel` resolves `frame_json.treatment` and passes to `ChroniclePresenceView`
- Chronicle panel body background, font, and accent border driven by Treatment
