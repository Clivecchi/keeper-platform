...
### 2026-09-17 — TypeSafe in ApiKeyForm
- Provider dropdown includes TypeSafe. Validation is length-only (same as Together / ElevenLabs). Key belongs in AI Access / Railway, not External Access MCP keys.
