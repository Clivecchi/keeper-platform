...
## Key Files
- `AgentPostureHeader.tsx` -- Shared banner for Agent Board: agent name, domain, lens, dialogue mode, governance, voice, live status. Used by AgentBoardFrame and KipAgentBoardPage.
