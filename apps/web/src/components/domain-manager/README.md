...
### DnsInfoPanel
- **Three-way DNS guidance**: required DNS records (registrar), current nameservers (detected), optional Vercel delegation NS
...
- **Compact Mode**: Condensed display for Chronicle Addresses and domain lists
