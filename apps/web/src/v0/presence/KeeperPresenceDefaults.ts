...
export const PRESENCE_SCHEMA_DEFAULTS: Record<string, ObjectPresenceSchema> = {
  ...
  agent: {
    ...
    fields: {
      ...
      role:               { role: 'quiet',     always: true,             editable: false, label: 'Role' },
      purpose:            { role: 'secondary', minDensity: 'standard', editable: true  },
      lensSystemPrompt:   {
        role: 'body',
        label: 'System Prompt',
  ...
  domain: {
    ...
    fields: {
      ...
      theme_color: { role: 'ambient',   minDensity: 'standard',           editable: true,  label: 'Theme Color' },
      visibility:  { role: 'quiet',     minDensity: 'standard',           editable: true,  label: 'Visibility' },
      treatmentName:         { role: 'secondary', minDensity: 'standard', editable: true, label: 'Treatment Name' },
      treatmentBackground:   { role: 'ambient',   minDensity: 'standard', editable: true, label: 'Treatment Background' },
      treatmentAccent:       { role: 'ambient',   minDensity: 'standard', editable: true, label: 'Treatment Accent' },
