...
import EchoWriter from '../../components/engagement/EchoWriter';

const EchoWriterPage: React.FC = () => {
  ...
  useEffect(() => {
    if (isDemo) {
      ...
      setKeeper({
        id: 'demo',
        title: 'Demo Keeper',
        purpose: 'Demonstration of Echo Writer functionality'
      });
      setLoading(false);
      return;
    }
