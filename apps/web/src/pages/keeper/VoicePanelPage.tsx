...
import VoicePanel from '../../components/engagement/VoicePanel';

const VoicePanelPage: React.FC = () => {
  ...
  useEffect(() => {
    if (isDemo) {
      ...
      setKeeper({
        id: 'demo',
        title: 'Demo Keeper',
        purpose: 'Demonstration of Voice Panel functionality'
      });
      setLoading(false);
      return;
    }
