...
export const ThemeProvider = ({ children }) => {
    ...
    const [theme, setTheme] = useState(KEEPER_CLASSIC_FALLBACK); // Initialize with fallback
    ...
    useEffect(() => {
        ...
        const tokensToApply = theme[mode];
    ...
    return (_jsx(ThemeContext.Provider, { value: { theme, mode, setMode }, children: children }));
};
