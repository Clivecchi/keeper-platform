...
export const SYSTEM_BOARD_DEFINITIONS: DefinitionMap = {
  ...
  'kip-agent': {
    ...
    frames: [
      ...
      {
        key: 'kip.related_journeys',
        name: 'Related Journeys',
        pattern: 'linked_card_list',
        frameType: 'media_card',
        order: 1,
        visibility: 'public',
        layout: {
        ...
        props: [
          {
            ...
            config: {
              ...
              subtitle: '8 moments · Professional',
          ...
          {
            id: 'journey-professional-development',
            type: 'linked_card',
            orderIndex: 1,
            config: {
              entityType: 'journey',
              entityId: 'journey-professional-development',
              title: 'Professional Development',
              subtitle: '5 moments · Learning plan',
